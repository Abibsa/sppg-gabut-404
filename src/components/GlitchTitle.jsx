...
export default function GlitchTitle() {
  return (
    <div className="text-center z-10 relative mt-16 mb-12">
      <h1 className="font-['Orbitron'] font-black text-[clamp(1.5rem,4vw,3.5rem)] text-[var(--accent-primary)] tracking-[0.15em] leading-none glow-title glitch-anim flicker-anim">
        {siteConfig.name}
      </h1>
