...
export default function MenuButton({ label, link, external }) {
  ...
  return (
    <motion.a
      ...
      className="btn-glow relative block w-full p-4 border border-[var(--border-glow)] bg-[var(--bg-main)]/90 rounded text-[var(--accent-primary)] font-['Orbitron'] uppercase tracking-[0.1em] font-bold transition-all duration-300 overflow-hidden group"
    >
